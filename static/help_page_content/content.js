...
let introduction = 'O Dashboard SCOPE trata-se de uma ferramenta de visualização geográfica ' +
	...
	'curvas epidémicas dos municípios da área de influência de cada Agrupamento de Centros de Saúde (ACES).';
...
let methods = 'As medidas de incidência e de incerteza representadas nos mapas do Dashboard SCOPE, ' +
	'são modeladas a partir da distribuição espacial do número de novos casos confirmados de COVID-19 por ' +
	'100 000 habitantes nos 14 dias anteriores ao dia analisado e por concelho (i.e. incidência cumulativa ou proporção ' +
	'de incidência, por concelho). <br><br>' +
	...
	'onde o número de casos é agregado por concelho. Nestes casos, os valores de incidência são constantes dentro de cada concelho ' +
	'e podem apresentar descontinuidades nas fronteiras entre eles (Figura 2.1a).<br><br>' +
...
let methods2_1b = 'Adicionalmente, para se obterem os mapas com elevada resolução espacial (que no caso ' +
	...
	'Para além disso, a discretização das áreas por concelho é crítica para o algoritmo geoestatístico na medida em que fornece ' +
...
let methods2_2a = 'Se um par de concelhos está próximo um do outro, em termos de distância euclideana, ' +
	...
	'reflecte o mais aproximadamente possível a correlação espacial observada na incidência cumulativa dos concelhos.';
